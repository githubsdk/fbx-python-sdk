...
static PyObject *meth_FbxBlendShape_Create(PyObject *sipSelf, PyObject *sipArgs)
{
...
{
    PyObject *sipParseErr = SIP_NULLPTR;
    bool sipSelfWasArg = (!PyObject_TypeCheck(sipSelf, sipTypeAsPyTypeObject(sipType_FbxBlendShape)) || sipIsDerivedClass((sipSimpleWrapper *)sipSelf));
...
static void *cast_FbxBlendShape(void *sipCppV, const sipTypeDef *targetType)
{
    ...
    if (targetType == sipType_FbxBlendShape)
        return sipCppV;
...
static PyMethodDef methods_FbxBlendShape[] = {
    {sipName_AddBlendShapeChannel, meth_FbxBlendShape_AddBlendShapeChannel, METH_VARARGS, doc_FbxBlendShape_AddBlendShapeChannel},
    {sipName_Create, meth_FbxBlendShape_Create, METH_VARARGS, doc_FbxBlendShape_Create},
    {sipName_GetBlendShapeChannel, meth_FbxBlendShape_GetBlendShapeChannel, METH_VARARGS, doc_FbxBlendShape_GetBlendShapeChannel},
    {sipName_GetBlendShapeChannelCount, meth_FbxBlendShape_GetBlendShapeChannelCount, METH_VARARGS, doc_FbxBlendShape_GetBlendShapeChannelCount},
    {sipName_GetClassId, meth_FbxBlendShape_GetClassId, METH_VARARGS, doc_FbxBlendShape_GetClassId},
    {sipName_GetDeformerType, meth_FbxBlendShape_GetDeformerType, METH_VARARGS, doc_FbxBlendShape_GetDeformerType},
    {sipName_GetGeometry, meth_FbxBlendShape_GetGeometry, METH_VARARGS, doc_FbxBlendShape_GetGeometry},
    {sipName_RemoveBlendShapeChannel, meth_FbxBlendShape_RemoveBlendShapeChannel, METH_VARARGS, doc_FbxBlendShape_RemoveBlendShapeChannel},
    {sipName_Reset, meth_FbxBlendShape_Reset, METH_VARARGS, doc_FbxBlendShape_Reset},
    {sipName_SetGeometry, meth_FbxBlendShape_SetGeometry, METH_VARARGS, doc_FbxBlendShape_SetGeometry}
};


extern "C" {static PyObject *varget_FbxBlendShape_ClassId(void *, PyObject *, PyObject *);}
static PyObject *varget_FbxBlendShape_ClassId(void *, PyObject *sipPySelf, PyObject *)
{
    ...
    if (sipPy)
    {
        sipKeepReference(sipPy, -469, sipPySelf);
        Py_INCREF(sipPy);
    }
...
sipVariableDef variables_FbxBlendShape[] = {
    {ClassVariable, sipName_ClassId, (PyMethodDef *)varget_FbxBlendShape_ClassId, (PyMethodDef *)varset_FbxBlendShape_ClassId, SIP_NULLPTR, SIP_NULLPTR},
};
