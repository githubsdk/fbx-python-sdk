...
#line 182 "D:\\Program Files\\Autodesk\\FBX\\FBX Python Bindings\\2020.3.4\\sip\\fbxtypes.sip"
        if (a0 < 0 || a0 >= 4)
        {
...
#line 136 "D:\\Program Files\\Autodesk\\FBX\\FBX Python Bindings\\2020.3.4\\build\\fbx/sipfbxFbxDouble4x4.cpp"

            if (sipIsErr)
                return 0;

            return sipConvertFromNewType(sipRes,sipType_FbxDouble4,SIP_NULLPTR);
        }
    }

    sipNoMethod(sipParseErr, sipName_FbxDouble4x4, sipName___getitem__, SIP_NULLPTR);
...
extern "C" {static void *array_FbxDouble4x4(Py_ssize_t);}
static void *array_FbxDouble4x4(Py_ssize_t sipNrElem)
{
    return new  ::FbxDouble4x4[sipNrElem];
}


extern "C" {static void assign_FbxDouble4x4(void *, Py_ssize_t, void *);}
static void assign_FbxDouble4x4(void *sipDst, Py_ssize_t sipDstIdx, void *sipSrc)
{
    reinterpret_cast< ::FbxDouble4x4 *>(sipDst)[sipDstIdx] = *reinterpret_cast< ::FbxDouble4x4 *>(sipSrc);
}


extern "C" {static void *copy_FbxDouble4x4(const void *, Py_ssize_t);}
static void *copy_FbxDouble4x4(const void *sipSrc, Py_ssize_t sipSrcIdx)
{
...
{
     ::FbxDouble4x4 *sipCpp = SIP_NULLPTR;
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, SIP_NULLPTR, sipUnused, "J9J9J9J9", sipType_FbxDouble4, &a0, sipType_FbxDouble4, &a1, sipType_FbxDouble4, &a2, sipType_FbxDouble4, &a3))
        {
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, SIP_NULLPTR, sipUnused, "J9", sipType_FbxDouble4x4, &a0))
        {
