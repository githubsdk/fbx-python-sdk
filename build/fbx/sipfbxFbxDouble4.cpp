...
#line 136 "D:\\Program Files\\Autodesk\\FBX\\FBX Python Bindings\\2020.3.4\\build\\fbx/sipfbxFbxDouble4.cpp"
    ...
    sipNoMethod(sipParseErr, sipName_FbxDouble4, sipName___getitem__, SIP_NULLPTR);
...
extern "C" {static void *array_FbxDouble4(Py_ssize_t);}
static void *array_FbxDouble4(Py_ssize_t sipNrElem)
{
    return new  ::FbxDouble4[sipNrElem];
}


extern "C" {static void assign_FbxDouble4(void *, Py_ssize_t, void *);}
static void assign_FbxDouble4(void *sipDst, Py_ssize_t sipDstIdx, void *sipSrc)
{
    reinterpret_cast< ::FbxDouble4 *>(sipDst)[sipDstIdx] = *reinterpret_cast< ::FbxDouble4 *>(sipSrc);
}


extern "C" {static void *copy_FbxDouble4(const void *, Py_ssize_t);}
static void *copy_FbxDouble4(const void *sipSrc, Py_ssize_t sipSrcIdx)
{
...
static void *init_type_FbxDouble4(sipSimpleWrapper *, PyObject *sipArgs, PyObject *sipKwds, PyObject **sipUnused, PyObject **, PyObject **sipParseErr)
{
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, SIP_NULLPTR, sipUnused, "J9", sipType_FbxDouble4, &a0))
        {
