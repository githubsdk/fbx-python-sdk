...
{
     ::FbxSystemUnit *sipCpp = SIP_NULLPTR;

    {
        double a0;
        double a1 = 1;

        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, SIP_NULLPTR, sipUnused, "d|d", &a0, &a1))
        {
...
static PyMethodDef methods_FbxSystemUnit[] = {
    {sipName_ConvertChildren, meth_FbxSystemUnit_ConvertChildren, METH_VARARGS, doc_FbxSystemUnit_ConvertChildren},
    {sipName_ConvertScene, meth_FbxSystemUnit_ConvertScene, METH_VARARGS, doc_FbxSystemUnit_ConvertScene},
    {sipName_GetConversionFactorFrom, meth_FbxSystemUnit_GetConversionFactorFrom, METH_VARARGS, doc_FbxSystemUnit_GetConversionFactorFrom},
    {sipName_GetConversionFactorTo, meth_FbxSystemUnit_GetConversionFactorTo, METH_VARARGS, doc_FbxSystemUnit_GetConversionFactorTo},
    {sipName_GetMultiplier, meth_FbxSystemUnit_GetMultiplier, METH_VARARGS, doc_FbxSystemUnit_GetMultiplier},
    {sipName_GetScaleFactor, meth_FbxSystemUnit_GetScaleFactor, METH_VARARGS, doc_FbxSystemUnit_GetScaleFactor},
    {sipName_GetScaleFactorAsString, meth_FbxSystemUnit_GetScaleFactorAsString, METH_VARARGS, doc_FbxSystemUnit_GetScaleFactorAsString},
    {sipName_GetScaleFactorAsString_Plurial, meth_FbxSystemUnit_GetScaleFactorAsString_Plurial, METH_VARARGS, doc_FbxSystemUnit_GetScaleFactorAsString_Plurial}
};
...
static PyObject *varget_FbxSystemUnit_DefaultConversionOptions(void *, PyObject *, PyObject *)
{
    ...
    return sipConvertFromNewType(const_cast< ::FbxSystemUnit::ConversionOptions *>(sipVal), sipType_FbxSystemUnit_ConversionOptions, SIP_NULLPTR);
}
...
static PyObject *varget_FbxSystemUnit_Foot(void *, PyObject *, PyObject *)
{
    ...
    return sipConvertFromNewType(const_cast< ::FbxSystemUnit *>(sipVal), sipType_FbxSystemUnit, SIP_NULLPTR);
}
...
static PyObject *varget_FbxSystemUnit_sPredefinedUnits(void *, PyObject *, PyObject *)
{
    ...
    return sipConvertFromType(const_cast< ::FbxSystemUnit *>(sipVal), sipType_FbxSystemUnit, SIP_NULLPTR);
}
...
static int varset_FbxSystemUnit_sPredefinedUnits(void *, PyObject *sipPy, PyObject *)
{
    const  ::FbxSystemUnit*sipVal;
    int sipIsErr = 0;
    sipVal = reinterpret_cast< ::FbxSystemUnit *>(sipForceConvertToType(sipPy, sipType_FbxSystemUnit, SIP_NULLPTR, 0, SIP_NULLPTR, &sipIsErr));
...
sipVariableDef variables_FbxSystemUnit[] = {
    {ClassVariable, sipName_DefaultConversionOptions, (PyMethodDef *)varget_FbxSystemUnit_DefaultConversionOptions, SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {ClassVariable, sipName_Foot, (PyMethodDef *)varget_FbxSystemUnit_Foot, SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {ClassVariable, sipName_Inch, (PyMethodDef *)varget_FbxSystemUnit_Inch, SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {ClassVariable, sipName_Mile, (PyMethodDef *)varget_FbxSystemUnit_Mile, SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {ClassVariable, sipName_Yard, (PyMethodDef *)varget_FbxSystemUnit_Yard, SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {ClassVariable, sipName_cm, (PyMethodDef *)varget_FbxSystemUnit_cm, SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {ClassVariable, sipName_dm, (PyMethodDef *)varget_FbxSystemUnit_dm, SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {ClassVariable, sipName_km, (PyMethodDef *)varget_FbxSystemUnit_km, SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {ClassVariable, sipName_m, (PyMethodDef *)varget_FbxSystemUnit_m, SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {ClassVariable, sipName_mm, (PyMethodDef *)varget_FbxSystemUnit_mm, SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {ClassVariable, sipName_sPredefinedUnits, (PyMethodDef *)varget_FbxSystemUnit_sPredefinedUnits, (PyMethodDef *)varset_FbxSystemUnit_sPredefinedUnits, SIP_NULLPTR, SIP_NULLPTR},
};
