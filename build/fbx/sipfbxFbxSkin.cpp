...
static PyObject *meth_FbxSkin_Create(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "CJ8A8", &sipSelf, sipType_FbxManager, &a0, &a1Keep, &a1))
        {
            ...
            return sipConvertFromType(sipRes,sipType_FbxSkin,SIP_NULLPTR);
        }
    }
...
{
    PyObject *sipParseErr = SIP_NULLPTR;
    bool sipSelfWasArg = (!PyObject_TypeCheck(sipSelf, sipTypeAsPyTypeObject(sipType_FbxSkin)) || sipIsDerivedClass((sipSimpleWrapper *)sipSelf));
...
static PyObject *meth_FbxSkin_GetSkinningType(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "B", &sipSelf, sipType_FbxSkin, &sipCpp))
        {
            ...
            return sipConvertFromEnum(static_cast<int>(sipRes), sipType_FbxSkin_EType);
        }
    }
...
#line 36 "D:\\Program Files\\Autodesk\\FBX\\FBX Python Bindings\\2020.3.4\\sip\\fbxskin.sip"
    int* indices;
    int indicesCount;
...
#line 507 "D:\\Program Files\\Autodesk\\FBX\\FBX Python Bindings\\2020.3.4\\build\\fbx/sipfbxFbxSkin.cpp"
...
#line 54 "D:\\Program Files\\Autodesk\\FBX\\FBX Python Bindings\\2020.3.4\\sip\\fbxskin.sip"
    double* blendWeights;
    int indicesCount;
...
#line 549 "D:\\Program Files\\Autodesk\\FBX\\FBX Python Bindings\\2020.3.4\\build\\fbx/sipfbxFbxSkin.cpp"
...
static PyMethodDef methods_FbxSkin[] = {
    {sipName_AddCluster, meth_FbxSkin_AddCluster, METH_VARARGS, doc_FbxSkin_AddCluster},
    {sipName_AddControlPointIndex, meth_FbxSkin_AddControlPointIndex, METH_VARARGS, doc_FbxSkin_AddControlPointIndex},
    {sipName_Create, meth_FbxSkin_Create, METH_VARARGS, doc_FbxSkin_Create},
    {sipName_GetClassId, meth_FbxSkin_GetClassId, METH_VARARGS, doc_FbxSkin_GetClassId},
    {sipName_GetCluster, meth_FbxSkin_GetCluster, METH_VARARGS, doc_FbxSkin_GetCluster},
    {sipName_GetClusterCount, meth_FbxSkin_GetClusterCount, METH_VARARGS, doc_FbxSkin_GetClusterCount},
    {sipName_GetControlPointBlendWeights, meth_FbxSkin_GetControlPointBlendWeights, METH_VARARGS, doc_FbxSkin_GetControlPointBlendWeights},
    {sipName_GetControlPointIndices, meth_FbxSkin_GetControlPointIndices, METH_VARARGS, doc_FbxSkin_GetControlPointIndices},
    {sipName_GetControlPointIndicesCount, meth_FbxSkin_GetControlPointIndicesCount, METH_VARARGS, doc_FbxSkin_GetControlPointIndicesCount},
    {sipName_GetDeformAccuracy, meth_FbxSkin_GetDeformAccuracy, METH_VARARGS, doc_FbxSkin_GetDeformAccuracy},
    {sipName_GetDeformerType, meth_FbxSkin_GetDeformerType, METH_VARARGS, doc_FbxSkin_GetDeformerType},
    {sipName_GetGeometry, meth_FbxSkin_GetGeometry, METH_VARARGS, doc_FbxSkin_GetGeometry},
    {sipName_GetSkinningType, meth_FbxSkin_GetSkinningType, METH_VARARGS, doc_FbxSkin_GetSkinningType},
    {sipName_RemoveCluster, meth_FbxSkin_RemoveCluster, METH_VARARGS, doc_FbxSkin_RemoveCluster},
    {sipName_SetControlPointIWCount, meth_FbxSkin_SetControlPointIWCount, METH_VARARGS, doc_FbxSkin_SetControlPointIWCount},
    {sipName_SetDeformAccuracy, meth_FbxSkin_SetDeformAccuracy, METH_VARARGS, doc_FbxSkin_SetDeformAccuracy},
    {sipName_SetGeometry, meth_FbxSkin_SetGeometry, METH_VARARGS, doc_FbxSkin_SetGeometry},
    {sipName_SetSkinningType, meth_FbxSkin_SetSkinningType, METH_VARARGS, doc_FbxSkin_SetSkinningType}
};


extern "C" {static PyObject *varget_FbxSkin_ClassId(void *, PyObject *, PyObject *);}
static PyObject *varget_FbxSkin_ClassId(void *, PyObject *sipPySelf, PyObject *)
{
    ...
    if (sipPy)
    {
        sipKeepReference(sipPy, -470, sipPySelf);
        Py_INCREF(sipPy);
    }
...
sipVariableDef variables_FbxSkin[] = {
    {ClassVariable, sipName_ClassId, (PyMethodDef *)varget_FbxSkin_ClassId, (PyMethodDef *)varset_FbxSkin_ClassId, SIP_NULLPTR, SIP_NULLPTR},
};


/* Define the enum members and ints to be added to this type. */
static sipIntInstanceDef intInstances_FbxSkin[] = {
    {sipName_eRigid, static_cast<int>( ::FbxSkin::eRigid)},
    {sipName_eLinear, static_cast<int>( ::FbxSkin::eLinear)},
    {sipName_eDualQuaternion, static_cast<int>( ::FbxSkin::eDualQuaternion)},
    {sipName_eBlend, static_cast<int>( ::FbxSkin::eBlend)},
    {0, 0}
};
...
sipClassTypeDef sipTypeDef_fbx_FbxSkin = {
    ...
    },
    {
        ...
        18, methods_FbxSkin,
        1, variables_FbxSkin,
        {SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR, intInstances_FbxSkin, SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    },
    SIP_NULLPTR,
    -1,
    -1,
