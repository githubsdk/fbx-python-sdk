...
sipFbxRenamingStrategyNumber::sipFbxRenamingStrategyNumber():  ::FbxRenamingStrategyNumber(), sipPySelf(SIP_NULLPTR)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}

sipFbxRenamingStrategyNumber::sipFbxRenamingStrategyNumber(const  ::FbxRenamingStrategyNumber& a0):  ::FbxRenamingStrategyNumber(a0), sipPySelf(SIP_NULLPTR)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}
...
static PyObject *meth_FbxRenamingStrategyNumber_Clear(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    bool sipSelfWasArg = (!PyObject_TypeCheck(sipSelf, sipTypeAsPyTypeObject(sipType_FbxRenamingStrategyNumber)) || sipIsDerivedClass((sipSimpleWrapper *)sipSelf));
...
static void *cast_FbxRenamingStrategyNumber(void *sipCppV, const sipTypeDef *targetType)
{
    ...
    if (targetType == sipType_FbxRenamingStrategyNumber)
        return sipCppV;
...
extern "C" {static void *array_FbxRenamingStrategyNumber(Py_ssize_t);}
static void *array_FbxRenamingStrategyNumber(Py_ssize_t sipNrElem)
{
    return new  ::FbxRenamingStrategyNumber[sipNrElem];
}


extern "C" {static void assign_FbxRenamingStrategyNumber(void *, Py_ssize_t, void *);}
static void assign_FbxRenamingStrategyNumber(void *sipDst, Py_ssize_t sipDstIdx, void *sipSrc)
{
    reinterpret_cast< ::FbxRenamingStrategyNumber *>(sipDst)[sipDstIdx] = *reinterpret_cast< ::FbxRenamingStrategyNumber *>(sipSrc);
}


extern "C" {static void *copy_FbxRenamingStrategyNumber(const void *, Py_ssize_t);}
static void *copy_FbxRenamingStrategyNumber(const void *sipSrc, Py_ssize_t sipSrcIdx)
{
...
static void dealloc_FbxRenamingStrategyNumber(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipFbxRenamingStrategyNumber *>(sipGetAddress(sipSelf))->sipPySelf = SIP_NULLPTR;
...
{
    sipFbxRenamingStrategyNumber *sipCpp = SIP_NULLPTR;
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, SIP_NULLPTR, sipUnused, "J9", sipType_FbxRenamingStrategyNumber, &a0))
        {
...
static PyMethodDef methods_FbxRenamingStrategyNumber[] = {
    {sipName_Clear, meth_FbxRenamingStrategyNumber_Clear, METH_VARARGS, doc_FbxRenamingStrategyNumber_Clear},
    {sipName_Clone, meth_FbxRenamingStrategyNumber_Clone, METH_VARARGS, doc_FbxRenamingStrategyNumber_Clone},
    {sipName_Rename, meth_FbxRenamingStrategyNumber_Rename, METH_VARARGS, doc_FbxRenamingStrategyNumber_Rename}
};
