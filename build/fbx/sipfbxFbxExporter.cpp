...
#include <fbxsdk.h>
#line 44 "D:\\Program Files\\Autodesk\\FBX\\FBX Python Bindings\\2020.3.4\\build\\fbx/sipfbxFbxExporter.cpp"
...
static PyObject *meth_FbxExporter_Create(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "CJ8A8", &sipSelf, sipType_FbxManager, &a0, &a1Keep, &a1))
        {
            ...
            return sipConvertFromType(sipRes,sipType_FbxExporter,SIP_NULLPTR);
        }
    }
...
{
    PyObject *sipParseErr = SIP_NULLPTR;
    bool sipSelfWasArg = (!PyObject_TypeCheck(sipSelf, sipTypeAsPyTypeObject(sipType_FbxExporter)) || sipIsDerivedClass((sipSimpleWrapper *)sipSelf));
...
static void *cast_FbxExporter(void *sipCppV, const sipTypeDef *targetType)
{
    ...
    if (targetType == sipType_FbxExporter)
        return sipCppV;
...
static PyMethodDef methods_FbxExporter[] = {
    {sipName_Create, meth_FbxExporter_Create, METH_VARARGS, doc_FbxExporter_Create},
    {sipName_Export, meth_FbxExporter_Export, METH_VARARGS, doc_FbxExporter_Export},
    {sipName_GetClassId, meth_FbxExporter_GetClassId, METH_VARARGS, doc_FbxExporter_GetClassId},
    {sipName_GetExportOptions, meth_FbxExporter_GetExportOptions, METH_VARARGS, doc_FbxExporter_GetExportOptions},
    {sipName_GetFileFormat, meth_FbxExporter_GetFileFormat, METH_VARARGS, doc_FbxExporter_GetFileFormat},
    {sipName_GetFileHeaderInfo, meth_FbxExporter_GetFileHeaderInfo, METH_VARARGS, doc_FbxExporter_GetFileHeaderInfo},
    {sipName_GetIOSettings, meth_FbxExporter_GetIOSettings, METH_VARARGS, doc_FbxExporter_GetIOSettings},
    {sipName_GetProgress, meth_FbxExporter_GetProgress, METH_VARARGS, doc_FbxExporter_GetProgress},
    {sipName_Initialize, meth_FbxExporter_Initialize, METH_VARARGS, doc_FbxExporter_Initialize},
    {sipName_IsExporting, meth_FbxExporter_IsExporting, METH_VARARGS, doc_FbxExporter_IsExporting},
    {sipName_IsFBX, meth_FbxExporter_IsFBX, METH_VARARGS, doc_FbxExporter_IsFBX},
    {sipName_SetDefaultRenderResolution, meth_FbxExporter_SetDefaultRenderResolution, METH_VARARGS, doc_FbxExporter_SetDefaultRenderResolution},
    {sipName_SetFileExportVersion, meth_FbxExporter_SetFileExportVersion, METH_VARARGS, doc_FbxExporter_SetFileExportVersion},
    {sipName_SetIOSettings, meth_FbxExporter_SetIOSettings, METH_VARARGS, doc_FbxExporter_SetIOSettings},
    {sipName_SetResamplingRate, meth_FbxExporter_SetResamplingRate, METH_VARARGS, doc_FbxExporter_SetResamplingRate},
    {sipName_TCSetDefinition, meth_FbxExporter_TCSetDefinition, METH_VARARGS, doc_FbxExporter_TCSetDefinition}
};


extern "C" {static PyObject *varget_FbxExporter_ClassId(void *, PyObject *, PyObject *);}
static PyObject *varget_FbxExporter_ClassId(void *, PyObject *sipPySelf, PyObject *)
{
    ...
    if (sipPy)
    {
        sipKeepReference(sipPy, -1126, sipPySelf);
        Py_INCREF(sipPy);
    }
...
sipVariableDef variables_FbxExporter[] = {
    {ClassVariable, sipName_ClassId, (PyMethodDef *)varget_FbxExporter_ClassId, (PyMethodDef *)varset_FbxExporter_ClassId, SIP_NULLPTR, SIP_NULLPTR},
};
