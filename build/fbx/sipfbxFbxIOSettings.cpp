...
static PyObject *meth_FbxIOSettings_Create(PyObject *sipSelf, PyObject *sipArgs)
{
...
{
    PyObject *sipParseErr = SIP_NULLPTR;
    bool sipSelfWasArg = (!PyObject_TypeCheck(sipSelf, sipTypeAsPyTypeObject(sipType_FbxIOSettings)) || sipIsDerivedClass((sipSimpleWrapper *)sipSelf));
...
static void *cast_FbxIOSettings(void *sipCppV, const sipTypeDef *targetType)
{
    ...
    if (targetType == sipType_FbxIOSettings)
        return sipCppV;
...
static PyMethodDef methods_FbxIOSettings[] = {
    {sipName_AddProperty, meth_FbxIOSettings_AddProperty, METH_VARARGS, doc_FbxIOSettings_AddProperty},
    {sipName_AddPropertyGroup, meth_FbxIOSettings_AddPropertyGroup, METH_VARARGS, doc_FbxIOSettings_AddPropertyGroup},
    {sipName_AddPropertyMinMax, meth_FbxIOSettings_AddPropertyMinMax, METH_VARARGS, doc_FbxIOSettings_AddPropertyMinMax},
    {sipName_Create, meth_FbxIOSettings_Create, METH_VARARGS, doc_FbxIOSettings_Create},
    {sipName_EmptyEnumProp, meth_FbxIOSettings_EmptyEnumProp, METH_VARARGS, doc_FbxIOSettings_EmptyEnumProp},
    {sipName_GetBoolProp, meth_FbxIOSettings_GetBoolProp, METH_VARARGS, doc_FbxIOSettings_GetBoolProp},
    {sipName_GetClassId, meth_FbxIOSettings_GetClassId, METH_VARARGS, doc_FbxIOSettings_GetClassId},
    {sipName_GetDoubleProp, meth_FbxIOSettings_GetDoubleProp, METH_VARARGS, doc_FbxIOSettings_GetDoubleProp},
    {sipName_GetEnumIndex, meth_FbxIOSettings_GetEnumIndex, METH_VARARGS, doc_FbxIOSettings_GetEnumIndex},
    {sipName_GetEnumProp, meth_FbxIOSettings_GetEnumProp, METH_VARARGS, doc_FbxIOSettings_GetEnumProp},
    {sipName_GetIntProp, meth_FbxIOSettings_GetIntProp, METH_VARARGS, doc_FbxIOSettings_GetIntProp},
    {sipName_GetProperty, meth_FbxIOSettings_GetProperty, METH_VARARGS, doc_FbxIOSettings_GetProperty},
    {sipName_GetStringProp, meth_FbxIOSettings_GetStringProp, METH_VARARGS, doc_FbxIOSettings_GetStringProp},
    {sipName_GetTimeProp, meth_FbxIOSettings_GetTimeProp, METH_VARARGS, doc_FbxIOSettings_GetTimeProp},
    {sipName_IsEnumExist, meth_FbxIOSettings_IsEnumExist, METH_VARARGS, doc_FbxIOSettings_IsEnumExist},
    {sipName_ReadXMLFile, meth_FbxIOSettings_ReadXMLFile, METH_VARARGS, doc_FbxIOSettings_ReadXMLFile},
    {sipName_RemoveEnumPropValue, meth_FbxIOSettings_RemoveEnumPropValue, METH_VARARGS, doc_FbxIOSettings_RemoveEnumPropValue},
    {sipName_SetBoolProp, meth_FbxIOSettings_SetBoolProp, METH_VARARGS, doc_FbxIOSettings_SetBoolProp},
    {sipName_SetDoubleProp, meth_FbxIOSettings_SetDoubleProp, METH_VARARGS, doc_FbxIOSettings_SetDoubleProp},
    {sipName_SetEnumProp, meth_FbxIOSettings_SetEnumProp, METH_VARARGS, doc_FbxIOSettings_SetEnumProp},
    {sipName_SetFlag, meth_FbxIOSettings_SetFlag, METH_VARARGS, doc_FbxIOSettings_SetFlag},
    {sipName_SetIntProp, meth_FbxIOSettings_SetIntProp, METH_VARARGS, doc_FbxIOSettings_SetIntProp},
    {sipName_SetStringProp, meth_FbxIOSettings_SetStringProp, METH_VARARGS, doc_FbxIOSettings_SetStringProp},
    {sipName_SetTimeProp, meth_FbxIOSettings_SetTimeProp, METH_VARARGS, doc_FbxIOSettings_SetTimeProp},
    {sipName_WriteXMLFile, meth_FbxIOSettings_WriteXMLFile, METH_VARARGS, doc_FbxIOSettings_WriteXMLFile},
    {sipName_WriteXmlPropToFile, meth_FbxIOSettings_WriteXmlPropToFile, METH_VARARGS, doc_FbxIOSettings_WriteXmlPropToFile}
};


extern "C" {static PyObject *varget_FbxIOSettings_ClassId(void *, PyObject *, PyObject *);}
static PyObject *varget_FbxIOSettings_ClassId(void *, PyObject *sipPySelf, PyObject *)
{
    ...
    if (sipPy)
    {
        sipKeepReference(sipPy, -1407, sipPySelf);
        Py_INCREF(sipPy);
    }
...
sipVariableDef variables_FbxIOSettings[] = {
    {ClassVariable, sipName_ClassId, (PyMethodDef *)varget_FbxIOSettings_ClassId, (PyMethodDef *)varset_FbxIOSettings_ClassId, SIP_NULLPTR, SIP_NULLPTR},
};
