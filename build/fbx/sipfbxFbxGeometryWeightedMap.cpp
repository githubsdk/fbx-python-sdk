...
static PyObject *meth_FbxGeometryWeightedMap_Create(PyObject *sipSelf, PyObject *sipArgs)
{
...
{
    PyObject *sipParseErr = SIP_NULLPTR;
    bool sipSelfWasArg = (!PyObject_TypeCheck(sipSelf, sipTypeAsPyTypeObject(sipType_FbxGeometryWeightedMap)) || sipIsDerivedClass((sipSimpleWrapper *)sipSelf));
...
static PyObject *meth_FbxGeometryWeightedMap_GetValues(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "B", &sipSelf, sipType_FbxGeometryWeightedMap, &sipCpp))
        {
            ...
            return sipConvertFromType(sipRes,sipType_FbxWeightedMapping,SIP_NULLPTR);
        }
    }
...
static void *cast_FbxGeometryWeightedMap(void *sipCppV, const sipTypeDef *targetType)
{
    ...
    if (targetType == sipType_FbxGeometryWeightedMap)
        return sipCppV;
...
static PyMethodDef methods_FbxGeometryWeightedMap[] = {
    {sipName_Create, meth_FbxGeometryWeightedMap_Create, METH_VARARGS, doc_FbxGeometryWeightedMap_Create},
    {sipName_GetClassId, meth_FbxGeometryWeightedMap_GetClassId, METH_VARARGS, doc_FbxGeometryWeightedMap_GetClassId},
    {sipName_GetDestinationGeometry, meth_FbxGeometryWeightedMap_GetDestinationGeometry, METH_VARARGS, doc_FbxGeometryWeightedMap_GetDestinationGeometry},
    {sipName_GetSourceGeometry, meth_FbxGeometryWeightedMap_GetSourceGeometry, METH_VARARGS, doc_FbxGeometryWeightedMap_GetSourceGeometry},
    {sipName_GetValues, meth_FbxGeometryWeightedMap_GetValues, METH_VARARGS, doc_FbxGeometryWeightedMap_GetValues},
    {sipName_SetValues, meth_FbxGeometryWeightedMap_SetValues, METH_VARARGS, doc_FbxGeometryWeightedMap_SetValues}
};


extern "C" {static PyObject *varget_FbxGeometryWeightedMap_ClassId(void *, PyObject *, PyObject *);}
static PyObject *varget_FbxGeometryWeightedMap_ClassId(void *, PyObject *sipPySelf, PyObject *)
{
    ...
    if (sipPy)
    {
        sipKeepReference(sipPy, -1477, sipPySelf);
        Py_INCREF(sipPy);
    }
...
sipVariableDef variables_FbxGeometryWeightedMap[] = {
    {ClassVariable, sipName_ClassId, (PyMethodDef *)varget_FbxGeometryWeightedMap_ClassId, (PyMethodDef *)varset_FbxGeometryWeightedMap_ClassId, SIP_NULLPTR, SIP_NULLPTR},
};
