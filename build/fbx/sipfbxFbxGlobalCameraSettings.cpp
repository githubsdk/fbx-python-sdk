...
#include <fbxsdk.h>
#line 44 "D:\\Program Files\\Autodesk\\FBX\\FBX Python Bindings\\2020.3.4\\build\\fbx/sipfbxFbxGlobalCameraSettings.cpp"
...
static PyObject *meth_FbxGlobalCameraSettings_GetDefaultViewingMode(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "B", &sipSelf, sipType_FbxGlobalCameraSettings, &sipCpp))
        {
            ...
            return sipConvertFromEnum(static_cast<int>(sipRes), sipType_FbxGlobalCameraSettings_EViewingMode);
        }
    }
...
static PyMethodDef methods_FbxGlobalCameraSettings[] = {
    {sipName_CreateProducerCameras, meth_FbxGlobalCameraSettings_CreateProducerCameras, METH_VARARGS, doc_FbxGlobalCameraSettings_CreateProducerCameras},
    {sipName_DestroyProducerCameras, meth_FbxGlobalCameraSettings_DestroyProducerCameras, METH_VARARGS, doc_FbxGlobalCameraSettings_DestroyProducerCameras},
    {sipName_GetCameraProducerBack, meth_FbxGlobalCameraSettings_GetCameraProducerBack, METH_VARARGS, doc_FbxGlobalCameraSettings_GetCameraProducerBack},
    {sipName_GetCameraProducerBottom, meth_FbxGlobalCameraSettings_GetCameraProducerBottom, METH_VARARGS, doc_FbxGlobalCameraSettings_GetCameraProducerBottom},
    {sipName_GetCameraProducerFront, meth_FbxGlobalCameraSettings_GetCameraProducerFront, METH_VARARGS, doc_FbxGlobalCameraSettings_GetCameraProducerFront},
    {sipName_GetCameraProducerLeft, meth_FbxGlobalCameraSettings_GetCameraProducerLeft, METH_VARARGS, doc_FbxGlobalCameraSettings_GetCameraProducerLeft},
    {sipName_GetCameraProducerPerspective, meth_FbxGlobalCameraSettings_GetCameraProducerPerspective, METH_VARARGS, doc_FbxGlobalCameraSettings_GetCameraProducerPerspective},
    {sipName_GetCameraProducerRight, meth_FbxGlobalCameraSettings_GetCameraProducerRight, METH_VARARGS, doc_FbxGlobalCameraSettings_GetCameraProducerRight},
    {sipName_GetCameraProducerTop, meth_FbxGlobalCameraSettings_GetCameraProducerTop, METH_VARARGS, doc_FbxGlobalCameraSettings_GetCameraProducerTop},
    {sipName_GetCameraSwitcher, meth_FbxGlobalCameraSettings_GetCameraSwitcher, METH_VARARGS, doc_FbxGlobalCameraSettings_GetCameraSwitcher},
    {sipName_GetDefaultCamera, meth_FbxGlobalCameraSettings_GetDefaultCamera, METH_VARARGS, doc_FbxGlobalCameraSettings_GetDefaultCamera},
    {sipName_GetDefaultViewingMode, meth_FbxGlobalCameraSettings_GetDefaultViewingMode, METH_VARARGS, doc_FbxGlobalCameraSettings_GetDefaultViewingMode},
    {sipName_IsProducerCamera, meth_FbxGlobalCameraSettings_IsProducerCamera, METH_VARARGS, doc_FbxGlobalCameraSettings_IsProducerCamera},
    {sipName_RestoreDefaultSettings, meth_FbxGlobalCameraSettings_RestoreDefaultSettings, METH_VARARGS, doc_FbxGlobalCameraSettings_RestoreDefaultSettings},
    {sipName_SetCameraSwitcher, meth_FbxGlobalCameraSettings_SetCameraSwitcher, METH_VARARGS, doc_FbxGlobalCameraSettings_SetCameraSwitcher},
    {sipName_SetDefaultCamera, meth_FbxGlobalCameraSettings_SetDefaultCamera, METH_VARARGS, doc_FbxGlobalCameraSettings_SetDefaultCamera},
    {sipName_SetDefaultViewingMode, meth_FbxGlobalCameraSettings_SetDefaultViewingMode, METH_VARARGS, doc_FbxGlobalCameraSettings_SetDefaultViewingMode}
};


/* Define the enum members and ints to be added to this type. */
static sipIntInstanceDef intInstances_FbxGlobalCameraSettings[] = {
    {sipName_eStandard, static_cast<int>( ::FbxGlobalCameraSettings::eStandard)},
    {sipName_eXRay, static_cast<int>( ::FbxGlobalCameraSettings::eXRay)},
    {sipName_eModelsOnly, static_cast<int>( ::FbxGlobalCameraSettings::eModelsOnly)},
    {0, 0}
};
...
sipClassTypeDef sipTypeDef_fbx_FbxGlobalCameraSettings = {
    ...
    },
    {
        ...
        0, SIP_NULLPTR,
        {SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR, intInstances_FbxGlobalCameraSettings, SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    },
    SIP_NULLPTR,
    -1,
    -1,
