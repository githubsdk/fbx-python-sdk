...
extern "C" {static void *array_FbxRotationOrder(Py_ssize_t);}
static void *array_FbxRotationOrder(Py_ssize_t sipNrElem)
{
    return new  ::FbxRotationOrder[sipNrElem];
}
...
{
     ::FbxRotationOrder *sipCpp = SIP_NULLPTR;

    {
         ::FbxEuler::EOrder a0 = FbxEuler::eOrderXYZ;

        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, SIP_NULLPTR, sipUnused, "|E", sipType_FbxEuler_EOrder, &a0))
        {
...
static PyMethodDef methods_FbxRotationOrder[] = {
    {sipName_GetOrder, meth_FbxRotationOrder_GetOrder, METH_VARARGS, doc_FbxRotationOrder_GetOrder},
    {sipName_M2V, meth_FbxRotationOrder_M2V, METH_VARARGS, doc_FbxRotationOrder_M2V},
    {sipName_SetOrder, meth_FbxRotationOrder_SetOrder, METH_VARARGS, doc_FbxRotationOrder_SetOrder},
    {sipName_V2M, meth_FbxRotationOrder_V2M, METH_VARARGS, doc_FbxRotationOrder_V2M},
    {sipName_V2VRef, meth_FbxRotationOrder_V2VRef, METH_VARARGS, doc_FbxRotationOrder_V2VRef}
};
