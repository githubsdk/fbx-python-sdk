...
sipFbxAnimCurveKey::sipFbxAnimCurveKey():  ::FbxAnimCurveKey(), sipPySelf(SIP_NULLPTR)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}

sipFbxAnimCurveKey::sipFbxAnimCurveKey( ::FbxTime a0):  ::FbxAnimCurveKey(a0), sipPySelf(SIP_NULLPTR)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}

sipFbxAnimCurveKey::sipFbxAnimCurveKey( ::FbxTime a0,float a1):  ::FbxAnimCurveKey(a0,a1), sipPySelf(SIP_NULLPTR)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}

sipFbxAnimCurveKey::sipFbxAnimCurveKey(const  ::FbxAnimCurveKey& a0):  ::FbxAnimCurveKey(a0), sipPySelf(SIP_NULLPTR)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}
 ...
 ::FbxTime sipFbxAnimCurveKey::GetTime() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState, const_cast<char *>(&sipPyMethods[0]), const_cast<sipSimpleWrapper **>(&sipPySelf), SIP_NULLPTR, sipName_GetTime);
...
void sipFbxAnimCurveKey::SetTime(const  ::FbxTime& a0)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState, &sipPyMethods[1], &sipPySelf, SIP_NULLPTR, sipName_SetTime);
...
static PyObject *meth_FbxAnimCurveKey_GetTime(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    bool sipSelfWasArg = (!PyObject_TypeCheck(sipSelf, sipTypeAsPyTypeObject(sipType_FbxAnimCurveKey)) || sipIsDerivedClass((sipSimpleWrapper *)sipSelf));
...
static PyObject *meth_FbxAnimCurveKey_GetTangentWeightMode(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "B", &sipSelf, sipType_FbxAnimCurveKey, &sipCpp))
        {
            ...
            return sipConvertFromEnum(static_cast<int>(sipRes), sipType_FbxAnimCurveDef_EWeightedMode);
        }
    }
...
static PyObject *meth_FbxAnimCurveKey_GetTangentVelocityMode(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "B", &sipSelf, sipType_FbxAnimCurveKey, &sipCpp))
        {
            ...
            return sipConvertFromEnum(static_cast<int>(sipRes), sipType_FbxAnimCurveDef_EVelocityMode);
        }
    }
...
static PyObject *meth_FbxAnimCurveKey_GetTangentVisibility(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "B", &sipSelf, sipType_FbxAnimCurveKey, &sipCpp))
        {
            ...
            return sipConvertFromEnum(static_cast<int>(sipRes), sipType_FbxAnimCurveDef_ETangentVisibility);
        }
    }
...
static void *cast_FbxAnimCurveKey(void *sipCppV, const sipTypeDef *targetType)
{
    ...
    if (targetType == sipType_FbxAnimCurveKey)
        return sipCppV;
...
extern "C" {static void *array_FbxAnimCurveKey(Py_ssize_t);}
static void *array_FbxAnimCurveKey(Py_ssize_t sipNrElem)
{
    return new  ::FbxAnimCurveKey[sipNrElem];
}


extern "C" {static void assign_FbxAnimCurveKey(void *, Py_ssize_t, void *);}
static void assign_FbxAnimCurveKey(void *sipDst, Py_ssize_t sipDstIdx, void *sipSrc)
{
    reinterpret_cast< ::FbxAnimCurveKey *>(sipDst)[sipDstIdx] = *reinterpret_cast< ::FbxAnimCurveKey *>(sipSrc);
}


extern "C" {static void *copy_FbxAnimCurveKey(const void *, Py_ssize_t);}
static void *copy_FbxAnimCurveKey(const void *sipSrc, Py_ssize_t sipSrcIdx)
{
...
static void dealloc_FbxAnimCurveKey(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipFbxAnimCurveKey *>(sipGetAddress(sipSelf))->sipPySelf = SIP_NULLPTR;
...
{
    sipFbxAnimCurveKey *sipCpp = SIP_NULLPTR;
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, SIP_NULLPTR, sipUnused, "J9", sipType_FbxTime, &a0))
        {
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, SIP_NULLPTR, sipUnused, "J9f", sipType_FbxTime, &a0, &a1))
        {
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, SIP_NULLPTR, sipUnused, "J9", sipType_FbxAnimCurveKey, &a0))
        {
            sipCpp = new sipFbxAnimCurveKey(*a0);
...
static PyMethodDef methods_FbxAnimCurveKey[] = {
    {sipName_GetBreak, meth_FbxAnimCurveKey_GetBreak, METH_VARARGS, doc_FbxAnimCurveKey_GetBreak},
    {sipName_GetConstantMode, meth_FbxAnimCurveKey_GetConstantMode, METH_VARARGS, doc_FbxAnimCurveKey_GetConstantMode},
    {sipName_GetDataFloat, meth_FbxAnimCurveKey_GetDataFloat, METH_VARARGS, doc_FbxAnimCurveKey_GetDataFloat},
    {sipName_GetInterpolation, meth_FbxAnimCurveKey_GetInterpolation, METH_VARARGS, doc_FbxAnimCurveKey_GetInterpolation},
    {sipName_GetTangentMode, meth_FbxAnimCurveKey_GetTangentMode, METH_VARARGS, doc_FbxAnimCurveKey_GetTangentMode},
    {sipName_GetTangentVelocityMode, meth_FbxAnimCurveKey_GetTangentVelocityMode, METH_VARARGS, doc_FbxAnimCurveKey_GetTangentVelocityMode},
    {sipName_GetTangentVisibility, meth_FbxAnimCurveKey_GetTangentVisibility, METH_VARARGS, doc_FbxAnimCurveKey_GetTangentVisibility},
    {sipName_GetTangentWeightMode, meth_FbxAnimCurveKey_GetTangentWeightMode, METH_VARARGS, doc_FbxAnimCurveKey_GetTangentWeightMode},
    {sipName_GetTime, meth_FbxAnimCurveKey_GetTime, METH_VARARGS, doc_FbxAnimCurveKey_GetTime},
    {sipName_GetValue, meth_FbxAnimCurveKey_GetValue, METH_VARARGS, doc_FbxAnimCurveKey_GetValue},
    {sipName_Set, meth_FbxAnimCurveKey_Set, METH_VARARGS, doc_FbxAnimCurveKey_Set},
    {sipName_SetBreak, meth_FbxAnimCurveKey_SetBreak, METH_VARARGS, doc_FbxAnimCurveKey_SetBreak},
    {sipName_SetConstantMode, meth_FbxAnimCurveKey_SetConstantMode, METH_VARARGS, doc_FbxAnimCurveKey_SetConstantMode},
    {sipName_SetDataFloat, meth_FbxAnimCurveKey_SetDataFloat, METH_VARARGS, doc_FbxAnimCurveKey_SetDataFloat},
    {sipName_SetInterpolation, meth_FbxAnimCurveKey_SetInterpolation, METH_VARARGS, doc_FbxAnimCurveKey_SetInterpolation},
    {sipName_SetTCB, meth_FbxAnimCurveKey_SetTCB, METH_VARARGS, doc_FbxAnimCurveKey_SetTCB},
    {sipName_SetTangentMode, meth_FbxAnimCurveKey_SetTangentMode, METH_VARARGS, doc_FbxAnimCurveKey_SetTangentMode},
    {sipName_SetTangentVelocityMode, meth_FbxAnimCurveKey_SetTangentVelocityMode, METH_VARARGS, doc_FbxAnimCurveKey_SetTangentVelocityMode},
    {sipName_SetTangentVisibility, meth_FbxAnimCurveKey_SetTangentVisibility, METH_VARARGS, doc_FbxAnimCurveKey_SetTangentVisibility},
    {sipName_SetTangentWeightMode, meth_FbxAnimCurveKey_SetTangentWeightMode, METH_VARARGS, doc_FbxAnimCurveKey_SetTangentWeightMode},
    {sipName_SetTime, meth_FbxAnimCurveKey_SetTime, METH_VARARGS, doc_FbxAnimCurveKey_SetTime},
    {sipName_SetValue, meth_FbxAnimCurveKey_SetValue, METH_VARARGS, doc_FbxAnimCurveKey_SetValue}
};
