...
#include <fbxsdk.h>
#line 44 "D:\\Program Files\\Autodesk\\FBX\\FBX Python Bindings\\2020.3.4\\build\\fbx/sipfbxFbxPose.cpp"
#line 5 "D:\\Program Files\\Autodesk\\FBX\\FBX Python Bindings\\2020.3.4\\sip\\fbxusernotification.sip"
#include <fbxsdk.h>
#line 47 "D:\\Program Files\\Autodesk\\FBX\\FBX Python Bindings\\2020.3.4\\build\\fbx/sipfbxFbxPose.cpp"
...
static PyObject *meth_FbxPose_Create(PyObject *sipSelf, PyObject *sipArgs)
{
...
{
    PyObject *sipParseErr = SIP_NULLPTR;
    bool sipSelfWasArg = (!PyObject_TypeCheck(sipSelf, sipTypeAsPyTypeObject(sipType_FbxPose)) || sipIsDerivedClass((sipSimpleWrapper *)sipSelf));
...
static PyObject *meth_FbxPose_GetNodeName(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "Bi", &sipSelf, sipType_FbxPose, &sipCpp, &a0))
        {
            ...
            return sipConvertFromNewType(sipRes,sipType_FbxNameHandler,SIP_NULLPTR);
        }
    }
...
static PyObject *meth_FbxPose_GetPosesContaining(PyObject *sipSelf, PyObject *sipArgs)
{
    PyObject *sipParseErr = SIP_NULLPTR;

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "CJ9J8J9J9", &sipSelf, sipType_FbxManager, &a0, sipType_FbxNode, &a1, sipType_FbxPoseArray, &a2, sipType_IntArray, &a3))
        {
            bool sipRes;
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "CJ8J8J9J9", &sipSelf, sipType_FbxScene, &a0, sipType_FbxNode, &a1, sipType_FbxPoseArray, &a2, sipType_IntArray, &a3))
        {
            bool sipRes;
...
static PyObject *meth_FbxPose_GetBindPoseContaining(PyObject *sipSelf, PyObject *sipArgs)
{
    PyObject *sipParseErr = SIP_NULLPTR;
...
static PyObject *meth_FbxPose_GetRestPoseContaining(PyObject *sipSelf, PyObject *sipArgs)
{
    PyObject *sipParseErr = SIP_NULLPTR;
...
static PyMethodDef methods_FbxPose[] = {
    {sipName_Add, meth_FbxPose_Add, METH_VARARGS, doc_FbxPose_Add},
    {sipName_Create, meth_FbxPose_Create, METH_VARARGS, doc_FbxPose_Create},
    {sipName_Find, meth_FbxPose_Find, METH_VARARGS, doc_FbxPose_Find},
    {sipName_GetBindPoseContaining, meth_FbxPose_GetBindPoseContaining, METH_VARARGS, doc_FbxPose_GetBindPoseContaining},
    {sipName_GetClassId, meth_FbxPose_GetClassId, METH_VARARGS, doc_FbxPose_GetClassId},
    {sipName_GetCount, meth_FbxPose_GetCount, METH_VARARGS, doc_FbxPose_GetCount},
    {sipName_GetMatrix, meth_FbxPose_GetMatrix, METH_VARARGS, doc_FbxPose_GetMatrix},
    {sipName_GetNode, meth_FbxPose_GetNode, METH_VARARGS, doc_FbxPose_GetNode},
    {sipName_GetNodeName, meth_FbxPose_GetNodeName, METH_VARARGS, doc_FbxPose_GetNodeName},
    {sipName_GetPosesContaining, meth_FbxPose_GetPosesContaining, METH_VARARGS, doc_FbxPose_GetPosesContaining},
    {sipName_GetRestPoseContaining, meth_FbxPose_GetRestPoseContaining, METH_VARARGS, doc_FbxPose_GetRestPoseContaining},
    {sipName_IsBindPose, meth_FbxPose_IsBindPose, METH_VARARGS, doc_FbxPose_IsBindPose},
    {sipName_IsLocalMatrix, meth_FbxPose_IsLocalMatrix, METH_VARARGS, doc_FbxPose_IsLocalMatrix},
    {sipName_IsRestPose, meth_FbxPose_IsRestPose, METH_VARARGS, doc_FbxPose_IsRestPose},
    {sipName_IsValidBindPose, meth_FbxPose_IsValidBindPose, METH_VARARGS, doc_FbxPose_IsValidBindPose},
    {sipName_IsValidBindPoseVerbose, meth_FbxPose_IsValidBindPoseVerbose, METH_VARARGS, doc_FbxPose_IsValidBindPoseVerbose},
    {sipName_Remove, meth_FbxPose_Remove, METH_VARARGS, doc_FbxPose_Remove},
    {sipName_SetIsBindPose, meth_FbxPose_SetIsBindPose, METH_VARARGS, doc_FbxPose_SetIsBindPose}
};


extern "C" {static PyObject *varget_FbxPose_ClassId(void *, PyObject *, PyObject *);}
static PyObject *varget_FbxPose_ClassId(void *, PyObject *sipPySelf, PyObject *)
{
    ...
    if (sipPy)
    {
        sipKeepReference(sipPy, -1350, sipPySelf);
        Py_INCREF(sipPy);
    }
...
sipVariableDef variables_FbxPose[] = {
    {ClassVariable, sipName_ClassId, (PyMethodDef *)varget_FbxPose_ClassId, (PyMethodDef *)varset_FbxPose_ClassId, SIP_NULLPTR, SIP_NULLPTR},
};


/* Define the enum members and ints to be added to this type. */
static sipIntInstanceDef intInstances_FbxPose[] = {
    {sipName_eInitialNameComponent, static_cast<int>( ::FbxPose::eInitialNameComponent)},
    {sipName_eCurrentNameComponent, static_cast<int>( ::FbxPose::eCurrentNameComponent)},
    {sipName_eAllNameComponents, static_cast<int>( ::FbxPose::eAllNameComponents)},
    {0, 0}
};
...
sipClassTypeDef sipTypeDef_fbx_FbxPose = {
    ...
    },
    {
        ...
        18, methods_FbxPose,
        1, variables_FbxPose,
        {SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR, intInstances_FbxPose, SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    },
    SIP_NULLPTR,
    -1,
    -1,
