...
static PyObject *meth_FbxPropertyESamplingType_Get(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "B", &sipSelf, sipType_FbxPropertyESamplingType, &sipCpp))
        {
            ...
            return sipConvertFromEnum(static_cast<int>(sipRes), sipType_FbxCamera_ESamplingType);
        }
    }
...
static void *cast_FbxPropertyESamplingType(void *sipCppV, const sipTypeDef *targetType)
{
    ...
    if (targetType == sipType_FbxPropertyESamplingType)
        return sipCppV;
...
extern "C" {static void *array_FbxPropertyESamplingType(Py_ssize_t);}
static void *array_FbxPropertyESamplingType(Py_ssize_t sipNrElem)
{
    return new  ::FbxPropertyESamplingType[sipNrElem];
}


extern "C" {static void assign_FbxPropertyESamplingType(void *, Py_ssize_t, void *);}
static void assign_FbxPropertyESamplingType(void *sipDst, Py_ssize_t sipDstIdx, void *sipSrc)
{
    reinterpret_cast< ::FbxPropertyESamplingType *>(sipDst)[sipDstIdx] = *reinterpret_cast< ::FbxPropertyESamplingType *>(sipSrc);
}


extern "C" {static void *copy_FbxPropertyESamplingType(const void *, Py_ssize_t);}
static void *copy_FbxPropertyESamplingType(const void *sipSrc, Py_ssize_t sipSrcIdx)
{
...
{
     ::FbxPropertyESamplingType *sipCpp = SIP_NULLPTR;
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, SIP_NULLPTR, sipUnused, "J9", sipType_FbxPropertyESamplingType, &a0))
        {
            sipCpp = new  ::FbxPropertyESamplingType(*a0);
...
static PyMethodDef methods_FbxPropertyESamplingType[] = {
    {sipName_Get, meth_FbxPropertyESamplingType_Get, METH_VARARGS, doc_FbxPropertyESamplingType_Get}
};
