...
static PyObject *meth_FbxConstraintPosition_Create(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "CJ8A8", &sipSelf, sipType_FbxManager, &a0, &a1Keep, &a1))
        {
            ...
            return sipConvertFromType(sipRes,sipType_FbxConstraintPosition,SIP_NULLPTR);
        }
    }
...
{
    PyObject *sipParseErr = SIP_NULLPTR;
    bool sipSelfWasArg = (!PyObject_TypeCheck(sipSelf, sipTypeAsPyTypeObject(sipType_FbxConstraintPosition)) || sipIsDerivedClass((sipSimpleWrapper *)sipSelf));
...
static void *cast_FbxConstraintPosition(void *sipCppV, const sipTypeDef *targetType)
{
    ...
    if (targetType == sipType_FbxConstraintPosition)
        return sipCppV;
...
static PyMethodDef methods_FbxConstraintPosition[] = {
    {sipName_AddConstraintSource, meth_FbxConstraintPosition_AddConstraintSource, METH_VARARGS, doc_FbxConstraintPosition_AddConstraintSource},
    {sipName_Create, meth_FbxConstraintPosition_Create, METH_VARARGS, doc_FbxConstraintPosition_Create},
    {sipName_GetClassId, meth_FbxConstraintPosition_GetClassId, METH_VARARGS, doc_FbxConstraintPosition_GetClassId},
    {sipName_GetConstrainedObject, meth_FbxConstraintPosition_GetConstrainedObject, METH_VARARGS, doc_FbxConstraintPosition_GetConstrainedObject},
    {sipName_GetConstraintSource, meth_FbxConstraintPosition_GetConstraintSource, METH_VARARGS, doc_FbxConstraintPosition_GetConstraintSource},
    {sipName_GetConstraintSourceCount, meth_FbxConstraintPosition_GetConstraintSourceCount, METH_VARARGS, doc_FbxConstraintPosition_GetConstraintSourceCount},
    {sipName_RemoveConstraintSource, meth_FbxConstraintPosition_RemoveConstraintSource, METH_VARARGS, doc_FbxConstraintPosition_RemoveConstraintSource},
    {sipName_SetConstrainedObject, meth_FbxConstraintPosition_SetConstrainedObject, METH_VARARGS, doc_FbxConstraintPosition_SetConstrainedObject}
};


extern "C" {static PyObject *varget_FbxConstraintPosition_Active(void *, PyObject *, PyObject *);}
static PyObject *varget_FbxConstraintPosition_Active(void *sipSelf, PyObject *sipPySelf, PyObject *)
{
    PyObject *sipPy;
     ::FbxPropertyBool1*sipVal;
     ::FbxConstraintPosition *sipCpp = reinterpret_cast< ::FbxConstraintPosition *>(sipSelf);

    sipPy = sipGetReference(sipPySelf, -545);
    ...
    if (sipPy)
    {
        sipKeepReference(sipPy, -544, sipPySelf);
        sipKeepReference(sipPySelf, -545, sipPy);
    }
...
static PyObject *varget_FbxConstraintPosition_AffectX(void *sipSelf, PyObject *sipPySelf, PyObject *)
{
    PyObject *sipPy;
     ::FbxPropertyBool1*sipVal;
     ::FbxConstraintPosition *sipCpp = reinterpret_cast< ::FbxConstraintPosition *>(sipSelf);

    sipPy = sipGetReference(sipPySelf, -547);
    ...
    if (sipPy)
    {
        sipKeepReference(sipPy, -546, sipPySelf);
        sipKeepReference(sipPySelf, -547, sipPy);
    }
...
static PyObject *varget_FbxConstraintPosition_AffectY(void *sipSelf, PyObject *sipPySelf, PyObject *)
{
    PyObject *sipPy;
     ::FbxPropertyBool1*sipVal;
     ::FbxConstraintPosition *sipCpp = reinterpret_cast< ::FbxConstraintPosition *>(sipSelf);

    sipPy = sipGetReference(sipPySelf, -549);
    ...
    if (sipPy)
    {
        sipKeepReference(sipPy, -548, sipPySelf);
        sipKeepReference(sipPySelf, -549, sipPy);
    }
...
static PyObject *varget_FbxConstraintPosition_AffectZ(void *sipSelf, PyObject *sipPySelf, PyObject *)
{
    PyObject *sipPy;
     ::FbxPropertyBool1*sipVal;
     ::FbxConstraintPosition *sipCpp = reinterpret_cast< ::FbxConstraintPosition *>(sipSelf);

    sipPy = sipGetReference(sipPySelf, -551);
    ...
    if (sipPy)
    {
        sipKeepReference(sipPy, -550, sipPySelf);
        sipKeepReference(sipPySelf, -551, sipPy);
    }
...
static PyObject *varget_FbxConstraintPosition_ClassId(void *, PyObject *sipPySelf, PyObject *)
{
    ...
    if (sipPy)
    {
        sipKeepReference(sipPy, -552, sipPySelf);
        Py_INCREF(sipPy);
    }
...
static PyObject *varget_FbxConstraintPosition_ConstrainedObject(void *sipSelf, PyObject *sipPySelf, PyObject *)
{
    PyObject *sipPy;
     ::FbxPropertyFbxReference*sipVal;
     ::FbxConstraintPosition *sipCpp = reinterpret_cast< ::FbxConstraintPosition *>(sipSelf);

    sipPy = sipGetReference(sipPySelf, -554);
    ...
    if (sipPy)
    {
        sipKeepReference(sipPy, -553, sipPySelf);
        sipKeepReference(sipPySelf, -554, sipPy);
    }
...
static PyObject *varget_FbxConstraintPosition_ConstraintSources(void *sipSelf, PyObject *sipPySelf, PyObject *)
{
    PyObject *sipPy;
     ::FbxPropertyFbxReference*sipVal;
     ::FbxConstraintPosition *sipCpp = reinterpret_cast< ::FbxConstraintPosition *>(sipSelf);

    sipPy = sipGetReference(sipPySelf, -556);
    ...
    if (sipPy)
    {
        sipKeepReference(sipPy, -555, sipPySelf);
        sipKeepReference(sipPySelf, -556, sipPy);
    }
...
static PyObject *varget_FbxConstraintPosition_Lock(void *sipSelf, PyObject *sipPySelf, PyObject *)
{
    PyObject *sipPy;
     ::FbxPropertyBool1*sipVal;
     ::FbxConstraintPosition *sipCpp = reinterpret_cast< ::FbxConstraintPosition *>(sipSelf);

    sipPy = sipGetReference(sipPySelf, -558);
    ...
    if (sipPy)
    {
        sipKeepReference(sipPy, -557, sipPySelf);
        sipKeepReference(sipPySelf, -558, sipPy);
    }
...
static PyObject *varget_FbxConstraintPosition_Translation(void *sipSelf, PyObject *sipPySelf, PyObject *)
{
    PyObject *sipPy;
     ::FbxPropertyDouble3*sipVal;
     ::FbxConstraintPosition *sipCpp = reinterpret_cast< ::FbxConstraintPosition *>(sipSelf);

    sipPy = sipGetReference(sipPySelf, -560);
    ...
    if (sipPy)
    {
        sipKeepReference(sipPy, -559, sipPySelf);
        sipKeepReference(sipPySelf, -560, sipPy);
    }
...
static PyObject *varget_FbxConstraintPosition_Weight(void *sipSelf, PyObject *sipPySelf, PyObject *)
{
    PyObject *sipPy;
     ::FbxPropertyDouble1*sipVal;
     ::FbxConstraintPosition *sipCpp = reinterpret_cast< ::FbxConstraintPosition *>(sipSelf);

    sipPy = sipGetReference(sipPySelf, -562);
    ...
    if (sipPy)
    {
        sipKeepReference(sipPy, -561, sipPySelf);
        sipKeepReference(sipPySelf, -562, sipPy);
    }
...
sipVariableDef variables_FbxConstraintPosition[] = {
    {InstanceVariable, sipName_Active, (PyMethodDef *)varget_FbxConstraintPosition_Active, (PyMethodDef *)varset_FbxConstraintPosition_Active, SIP_NULLPTR, SIP_NULLPTR},
    {InstanceVariable, sipName_AffectX, (PyMethodDef *)varget_FbxConstraintPosition_AffectX, (PyMethodDef *)varset_FbxConstraintPosition_AffectX, SIP_NULLPTR, SIP_NULLPTR},
    {InstanceVariable, sipName_AffectY, (PyMethodDef *)varget_FbxConstraintPosition_AffectY, (PyMethodDef *)varset_FbxConstraintPosition_AffectY, SIP_NULLPTR, SIP_NULLPTR},
    {InstanceVariable, sipName_AffectZ, (PyMethodDef *)varget_FbxConstraintPosition_AffectZ, (PyMethodDef *)varset_FbxConstraintPosition_AffectZ, SIP_NULLPTR, SIP_NULLPTR},
    {ClassVariable, sipName_ClassId, (PyMethodDef *)varget_FbxConstraintPosition_ClassId, (PyMethodDef *)varset_FbxConstraintPosition_ClassId, SIP_NULLPTR, SIP_NULLPTR},
    {InstanceVariable, sipName_ConstrainedObject, (PyMethodDef *)varget_FbxConstraintPosition_ConstrainedObject, (PyMethodDef *)varset_FbxConstraintPosition_ConstrainedObject, SIP_NULLPTR, SIP_NULLPTR},
    {InstanceVariable, sipName_ConstraintSources, (PyMethodDef *)varget_FbxConstraintPosition_ConstraintSources, (PyMethodDef *)varset_FbxConstraintPosition_ConstraintSources, SIP_NULLPTR, SIP_NULLPTR},
    {InstanceVariable, sipName_Lock, (PyMethodDef *)varget_FbxConstraintPosition_Lock, (PyMethodDef *)varset_FbxConstraintPosition_Lock, SIP_NULLPTR, SIP_NULLPTR},
    {InstanceVariable, sipName_Translation, (PyMethodDef *)varget_FbxConstraintPosition_Translation, (PyMethodDef *)varset_FbxConstraintPosition_Translation, SIP_NULLPTR, SIP_NULLPTR},
    {InstanceVariable, sipName_Weight, (PyMethodDef *)varget_FbxConstraintPosition_Weight, (PyMethodDef *)varset_FbxConstraintPosition_Weight, SIP_NULLPTR, SIP_NULLPTR},
};
