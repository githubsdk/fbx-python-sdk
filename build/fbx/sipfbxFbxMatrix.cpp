...
static void *cast_FbxMatrix(void *sipCppV, const sipTypeDef *targetType)
{
    ...
    if (targetType == sipType_FbxMatrix)
        return sipCppV;
...
extern "C" {static void *array_FbxMatrix(Py_ssize_t);}
static void *array_FbxMatrix(Py_ssize_t sipNrElem)
{
    return new  ::FbxMatrix[sipNrElem];
}


extern "C" {static void assign_FbxMatrix(void *, Py_ssize_t, void *);}
static void assign_FbxMatrix(void *sipDst, Py_ssize_t sipDstIdx, void *sipSrc)
{
    reinterpret_cast< ::FbxMatrix *>(sipDst)[sipDstIdx] = *reinterpret_cast< ::FbxMatrix *>(sipSrc);
}


extern "C" {static void *copy_FbxMatrix(const void *, Py_ssize_t);}
static void *copy_FbxMatrix(const void *sipSrc, Py_ssize_t sipSrcIdx)
{
...
static void *init_type_FbxMatrix(sipSimpleWrapper *, PyObject *sipArgs, PyObject *sipKwds, PyObject **sipUnused, PyObject **, PyObject **sipParseErr)
{
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, SIP_NULLPTR, sipUnused, "J9", sipType_FbxMatrix, &a0))
        {
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, SIP_NULLPTR, sipUnused, "J9J9J9", sipType_FbxVector4, &a0, sipType_FbxQuaternion, &a1, sipType_FbxVector4, &a2))
        {
            sipCpp = new  ::FbxMatrix(*a0,*a1,*a2);
...
static PyMethodDef methods_FbxMatrix[] = {
    {sipName_Get, meth_FbxMatrix_Get, METH_VARARGS, doc_FbxMatrix_Get},
    {sipName_GetColumn, meth_FbxMatrix_GetColumn, METH_VARARGS, doc_FbxMatrix_GetColumn},
    {sipName_GetElements, meth_FbxMatrix_GetElements, METH_VARARGS, doc_FbxMatrix_GetElements},
    {sipName_GetRow, meth_FbxMatrix_GetRow, METH_VARARGS, doc_FbxMatrix_GetRow},
    {sipName_Inverse, meth_FbxMatrix_Inverse, METH_VARARGS, doc_FbxMatrix_Inverse},
    {sipName_MultNormalize, meth_FbxMatrix_MultNormalize, METH_VARARGS, doc_FbxMatrix_MultNormalize},
    {sipName_Set, meth_FbxMatrix_Set, METH_VARARGS, doc_FbxMatrix_Set},
    {sipName_SetColumn, meth_FbxMatrix_SetColumn, METH_VARARGS, doc_FbxMatrix_SetColumn},
    {sipName_SetIdentity, meth_FbxMatrix_SetIdentity, METH_VARARGS, doc_FbxMatrix_SetIdentity},
    {sipName_SetRow, meth_FbxMatrix_SetRow, METH_VARARGS, doc_FbxMatrix_SetRow},
    {sipName_SetTQS, meth_FbxMatrix_SetTQS, METH_VARARGS, doc_FbxMatrix_SetTQS},
    {sipName_SetTRS, meth_FbxMatrix_SetTRS, METH_VARARGS, doc_FbxMatrix_SetTRS},
    {sipName_Transpose, meth_FbxMatrix_Transpose, METH_VARARGS, doc_FbxMatrix_Transpose}
};
