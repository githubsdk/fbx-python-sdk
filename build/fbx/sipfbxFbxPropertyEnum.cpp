...
static void *cast_FbxPropertyEnum(void *sipCppV, const sipTypeDef *targetType)
{
    ...
    if (targetType == sipType_FbxPropertyEnum)
        return sipCppV;
...
extern "C" {static void *array_FbxPropertyEnum(Py_ssize_t);}
static void *array_FbxPropertyEnum(Py_ssize_t sipNrElem)
{
    return new  ::FbxPropertyEnum[sipNrElem];
}


extern "C" {static void assign_FbxPropertyEnum(void *, Py_ssize_t, void *);}
static void assign_FbxPropertyEnum(void *sipDst, Py_ssize_t sipDstIdx, void *sipSrc)
{
    reinterpret_cast< ::FbxPropertyEnum *>(sipDst)[sipDstIdx] = *reinterpret_cast< ::FbxPropertyEnum *>(sipSrc);
}


extern "C" {static void *copy_FbxPropertyEnum(const void *, Py_ssize_t);}
static void *copy_FbxPropertyEnum(const void *sipSrc, Py_ssize_t sipSrcIdx)
{
...
{
     ::FbxPropertyEnum *sipCpp = SIP_NULLPTR;
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, SIP_NULLPTR, sipUnused, "J9", sipType_FbxPropertyEnum, &a0))
        {
            sipCpp = new  ::FbxPropertyEnum(*a0);
...
static PyMethodDef methods_FbxPropertyEnum[] = {
    {sipName_Get, meth_FbxPropertyEnum_Get, METH_VARARGS, doc_FbxPropertyEnum_Get}
};
