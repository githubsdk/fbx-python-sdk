...
sipFbxLayerElementArrayTemplate_FbxVector2::sipFbxLayerElementArrayTemplate_FbxVector2( ::EFbxType a0):  ::FbxLayerElementArrayTemplate_FbxVector2(a0), sipPySelf(SIP_NULLPTR)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}

sipFbxLayerElementArrayTemplate_FbxVector2::sipFbxLayerElementArrayTemplate_FbxVector2(const  ::FbxLayerElementArrayTemplate_FbxVector2& a0):  ::FbxLayerElementArrayTemplate_FbxVector2(a0), sipPySelf(SIP_NULLPTR)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}
...
#line 525 "D:\\Program Files\\Autodesk\\FBX\\FBX Python Bindings\\2020.3.4\\build\\fbx/sipfbxFbxLayerElementArrayTemplate_FbxVector2.cpp"
    ...
    sipNoMethod(sipParseErr, sipName_FbxLayerElementArrayTemplate_FbxVector2, sipName___getitem__, SIP_NULLPTR);
...
static void *cast_FbxLayerElementArrayTemplate_FbxVector2(void *sipCppV, const sipTypeDef *targetType)
{
    ...
    if (targetType == sipType_FbxLayerElementArrayTemplate_FbxVector2)
        return sipCppV;
...
extern "C" {static void assign_FbxLayerElementArrayTemplate_FbxVector2(void *, Py_ssize_t, void *);}
static void assign_FbxLayerElementArrayTemplate_FbxVector2(void *sipDst, Py_ssize_t sipDstIdx, void *sipSrc)
{
    reinterpret_cast< ::FbxLayerElementArrayTemplate_FbxVector2 *>(sipDst)[sipDstIdx] = *reinterpret_cast< ::FbxLayerElementArrayTemplate_FbxVector2 *>(sipSrc);
}


extern "C" {static void *copy_FbxLayerElementArrayTemplate_FbxVector2(const void *, Py_ssize_t);}
static void *copy_FbxLayerElementArrayTemplate_FbxVector2(const void *sipSrc, Py_ssize_t sipSrcIdx)
{
    return new  ::FbxLayerElementArrayTemplate_FbxVector2(reinterpret_cast<const  ::FbxLayerElementArrayTemplate_FbxVector2 *>(sipSrc)[sipSrcIdx]);
}
...
static void dealloc_FbxLayerElementArrayTemplate_FbxVector2(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipFbxLayerElementArrayTemplate_FbxVector2 *>(sipGetAddress(sipSelf))->sipPySelf = SIP_NULLPTR;
...
{
    sipFbxLayerElementArrayTemplate_FbxVector2 *sipCpp = SIP_NULLPTR;
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, SIP_NULLPTR, sipUnused, "J9", sipType_FbxLayerElementArrayTemplate_FbxVector2, &a0))
        {
            sipCpp = new sipFbxLayerElementArrayTemplate_FbxVector2(*a0);
...
static PyMethodDef methods_FbxLayerElementArrayTemplate_FbxVector2[] = {
    {sipName_Add, meth_FbxLayerElementArrayTemplate_FbxVector2_Add, METH_VARARGS, doc_FbxLayerElementArrayTemplate_FbxVector2_Add},
    {sipName_Find, meth_FbxLayerElementArrayTemplate_FbxVector2_Find, METH_VARARGS, doc_FbxLayerElementArrayTemplate_FbxVector2_Find},
    {sipName_FindAfter, meth_FbxLayerElementArrayTemplate_FbxVector2_FindAfter, METH_VARARGS, doc_FbxLayerElementArrayTemplate_FbxVector2_FindAfter},
    {sipName_FindBefore, meth_FbxLayerElementArrayTemplate_FbxVector2_FindBefore, METH_VARARGS, doc_FbxLayerElementArrayTemplate_FbxVector2_FindBefore},
    {sipName_GetAt, meth_FbxLayerElementArrayTemplate_FbxVector2_GetAt, METH_VARARGS, doc_FbxLayerElementArrayTemplate_FbxVector2_GetAt},
    {sipName_GetFirst, meth_FbxLayerElementArrayTemplate_FbxVector2_GetFirst, METH_VARARGS, doc_FbxLayerElementArrayTemplate_FbxVector2_GetFirst},
    {sipName_GetLast, meth_FbxLayerElementArrayTemplate_FbxVector2_GetLast, METH_VARARGS, doc_FbxLayerElementArrayTemplate_FbxVector2_GetLast},
    {sipName_InsertAt, meth_FbxLayerElementArrayTemplate_FbxVector2_InsertAt, METH_VARARGS, doc_FbxLayerElementArrayTemplate_FbxVector2_InsertAt},
    {sipName_RemoveAt, meth_FbxLayerElementArrayTemplate_FbxVector2_RemoveAt, METH_VARARGS, doc_FbxLayerElementArrayTemplate_FbxVector2_RemoveAt},
    {sipName_RemoveIt, meth_FbxLayerElementArrayTemplate_FbxVector2_RemoveIt, METH_VARARGS, doc_FbxLayerElementArrayTemplate_FbxVector2_RemoveIt},
    {sipName_RemoveLast, meth_FbxLayerElementArrayTemplate_FbxVector2_RemoveLast, METH_VARARGS, doc_FbxLayerElementArrayTemplate_FbxVector2_RemoveLast},
    {sipName_SetAt, meth_FbxLayerElementArrayTemplate_FbxVector2_SetAt, METH_VARARGS, doc_FbxLayerElementArrayTemplate_FbxVector2_SetAt},
    {sipName_SetLast, meth_FbxLayerElementArrayTemplate_FbxVector2_SetLast, METH_VARARGS, doc_FbxLayerElementArrayTemplate_FbxVector2_SetLast}
};
...
sipClassTypeDef sipTypeDef_fbx_FbxLayerElementArrayTemplate_FbxVector2 = {
    ...
    assign_FbxLayerElementArrayTemplate_FbxVector2,
    SIP_NULLPTR,
    copy_FbxLayerElementArrayTemplate_FbxVector2,
