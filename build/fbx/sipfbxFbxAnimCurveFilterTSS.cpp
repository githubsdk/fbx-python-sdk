...
#include <fbxsdk.h>
#line 44 "D:\\Program Files\\Autodesk\\FBX\\FBX Python Bindings\\2020.3.4\\build\\fbx/sipfbxFbxAnimCurveFilterTSS.cpp"
...
sipFbxAnimCurveFilterTSS::sipFbxAnimCurveFilterTSS():  ::FbxAnimCurveFilterTSS(), sipPySelf(SIP_NULLPTR)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}

sipFbxAnimCurveFilterTSS::sipFbxAnimCurveFilterTSS(const  ::FbxAnimCurveFilterTSS& a0):  ::FbxAnimCurveFilterTSS(a0), sipPySelf(SIP_NULLPTR)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}
...
const char* sipFbxAnimCurveFilterTSS::GetName() const
{
    ...
    return sipVH_fbx_27(sipGILState, 0, sipPySelf, sipMeth, -1492);
}
...
static PyObject *meth_FbxAnimCurveFilterTSS_GetName(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    bool sipSelfWasArg = (!PyObject_TypeCheck(sipSelf, sipTypeAsPyTypeObject(sipType_FbxAnimCurveFilterTSS)) || sipIsDerivedClass((sipSimpleWrapper *)sipSelf));
...
static void *cast_FbxAnimCurveFilterTSS(void *sipCppV, const sipTypeDef *targetType)
{
    ...
    if (targetType == sipType_FbxAnimCurveFilterTSS)
        return sipCppV;
...
extern "C" {static void *array_FbxAnimCurveFilterTSS(Py_ssize_t);}
static void *array_FbxAnimCurveFilterTSS(Py_ssize_t sipNrElem)
{
    return new  ::FbxAnimCurveFilterTSS[sipNrElem];
}


extern "C" {static void assign_FbxAnimCurveFilterTSS(void *, Py_ssize_t, void *);}
static void assign_FbxAnimCurveFilterTSS(void *sipDst, Py_ssize_t sipDstIdx, void *sipSrc)
{
    reinterpret_cast< ::FbxAnimCurveFilterTSS *>(sipDst)[sipDstIdx] = *reinterpret_cast< ::FbxAnimCurveFilterTSS *>(sipSrc);
}


extern "C" {static void *copy_FbxAnimCurveFilterTSS(const void *, Py_ssize_t);}
static void *copy_FbxAnimCurveFilterTSS(const void *sipSrc, Py_ssize_t sipSrcIdx)
{
...
static void dealloc_FbxAnimCurveFilterTSS(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipFbxAnimCurveFilterTSS *>(sipGetAddress(sipSelf))->sipPySelf = SIP_NULLPTR;
...
{
    sipFbxAnimCurveFilterTSS *sipCpp = SIP_NULLPTR;
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, SIP_NULLPTR, sipUnused, "J9", sipType_FbxAnimCurveFilterTSS, &a0))
        {
...
static PyMethodDef methods_FbxAnimCurveFilterTSS[] = {
    {sipName_Apply, meth_FbxAnimCurveFilterTSS_Apply, METH_VARARGS, doc_FbxAnimCurveFilterTSS_Apply},
    {sipName_GetName, meth_FbxAnimCurveFilterTSS_GetName, METH_VARARGS, doc_FbxAnimCurveFilterTSS_GetName},
    {sipName_GetScale, meth_FbxAnimCurveFilterTSS_GetScale, METH_VARARGS, doc_FbxAnimCurveFilterTSS_GetScale},
    {sipName_GetShift, meth_FbxAnimCurveFilterTSS_GetShift, METH_VARARGS, doc_FbxAnimCurveFilterTSS_GetShift},
    {sipName_Reset, meth_FbxAnimCurveFilterTSS_Reset, METH_VARARGS, doc_FbxAnimCurveFilterTSS_Reset},
    {sipName_SetScale, meth_FbxAnimCurveFilterTSS_SetScale, METH_VARARGS, doc_FbxAnimCurveFilterTSS_SetScale},
    {sipName_SetShift, meth_FbxAnimCurveFilterTSS_SetShift, METH_VARARGS, doc_FbxAnimCurveFilterTSS_SetShift}
};
